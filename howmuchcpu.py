...
if len(outputs)==0:
    print("No outputs found. Change directory to your run folder and rerun howmuchcpu.py")
    exit(1)
...
try:
    ...
    p.savefig("howmuchcpu.pdf")
       
    print("Wrote a report as howmuchcpu.pdf")
